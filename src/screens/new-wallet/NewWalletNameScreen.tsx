...
const NewWalletNameScreen = ({ navigation }: ScreenProps) => {
  return (
    <Screen>
      <AnimationContainer>
        <LottieView source={animationSrc} autoPlay />
      </AnimationContainer>
      <InstructionsContainer>
        <InstructionsFirstLine>Let’s get you a new wallet.</InstructionsFirstLine>
        <InstructionsSecondLine>How should we call it?</InstructionsSecondLine>
      </InstructionsContainer>
      <ActionsContainer>
        <ButtonStack>
