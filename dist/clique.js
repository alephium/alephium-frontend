...
var CliqueClient = /** @class */ (function () {
    ...
    CliqueClient.prototype.getClientIndex = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getGroupIndex(address)];
                    case 1:
                        group = _a.sent();
    ...
    CliqueClient.prototype.getGroupIndex = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.clients[0].getGroup(address)];
    ...
    CliqueClient.prototype.getBalance = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getClientIndex(address)];
                    case 1:
                        client = _a.sent();
    ...
    CliqueClient.prototype.transactionCreate = function (fromAddress, fromKey, toAddress, value, lockTime) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getClientIndex(fromAddress)];
                    case 1:
                        client = _a.sent();
