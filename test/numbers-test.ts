...
it('should convert to qALPH', () => {
  expect(convertToQALPH('-1')).toEqual(BigInt('-1000000000000000000')),
    expect(convertToQALPH('0')).toEqual(BigInt(0)),
    expect(convertToQALPH('1')).toEqual(BigInt('1000000000000000000')),
    expect(convertToQALPH('10')).toEqual(BigInt('10000000000000000000')),
    expect(convertToQALPH('999999999')).toEqual(BigInt('999999999000000000000000000')),
    expect(convertToQALPH('999999999999')).toEqual(BigInt('999999999999000000000000000000')),
    expect(convertToQALPH('0.1')).toEqual(BigInt('100000000000000000')),
    expect(convertToQALPH('.1')).toEqual(BigInt('100000000000000000')),
    expect(convertToQALPH('0.01')).toEqual(BigInt('10000000000000000')),
    expect(convertToQALPH('0.00000009')).toEqual(BigInt('90000000000')),
    expect(convertToQALPH('0.000000000000000001')).toEqual(BigInt('1')),
    expect(convertToQALPH('-0.000000000000000001')).toEqual(BigInt('-1')),
    expect(convertToQALPH('1e-1')).toEqual(BigInt('100000000000000000')),
    expect(convertToQALPH('1e-2')).toEqual(BigInt('10000000000000000')),
    expect(convertToQALPH('1e-17')).toEqual(BigInt('10')),
    expect(convertToQALPH('1e-18')).toEqual(BigInt('1')),
    expect(convertToQALPH('1.1e-1')).toEqual(BigInt('110000000000000000')),
    expect(convertToQALPH('1.11e-1')).toEqual(BigInt('111000000000000000')),
    expect(convertToQALPH('1.99999999999999999e-1')).toEqual(BigInt('199999999999999999')),
    expect(convertToQALPH('1e+1')).toEqual(BigInt('10000000000000000000')),
    expect(convertToQALPH('1e+2')).toEqual(BigInt('100000000000000000000')),
    expect(convertToQALPH('1e+17')).toEqual(BigInt('100000000000000000000000000000000000')),
    expect(convertToQALPH('1e+18')).toEqual(BigInt('1000000000000000000000000000000000000')),
    expect(convertToQALPH('1.1e+1')).toEqual(BigInt('11000000000000000000')),
    expect(convertToQALPH('1.99999999999999999e+1')).toEqual(BigInt('19999999999999999900')),
    expect(convertToQALPH('123.45678e+2')).toEqual(BigInt('12345678000000000000000')),
    expect(convertToQALPH('-1e-1')).toEqual(BigInt('-100000000000000000')),
    expect(convertToQALPH('-1e-2')).toEqual(BigInt('-10000000000000000')),
    expect(convertToQALPH('-1e-17')).toEqual(BigInt('-10')),
    expect(convertToQALPH('-1e-18')).toEqual(BigInt('-1')),
