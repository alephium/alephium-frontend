...
import { EngineTypes, SignClientTypes, SessionTypes, JsonRpcRecord, MessageRecord } from '@walletconnect/types'
import { getSdkError, objToMap, mapToObj, calcExpiry } from '@walletconnect/utils'
import {
      ...
      try {
        switch (requestEvent.params.request.method as RelayMethod) {
          ...
          case 'alph_requestNodeApi': {
            ...
            await cleanStorage(requestEvent)
