...
import discordLogo from '@/images/brand-icon-discord.svg?url'
import githubLogo from '@/images/brand-icon-github.svg?url'
import twitterLogo from '@/images/brand-icon-twitter.svg?url'
