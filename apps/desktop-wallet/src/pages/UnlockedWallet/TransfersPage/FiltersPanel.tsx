...
const FiltersPanel = ({
  ...
  useEffect(() => {
    if (areVerifiedFungibleTokensInitialized && !stateUninitialized && !selectedAssets) {
      setSelectedAssets(assets)
    }
  }, [areVerifiedFungibleTokensInitialized, assets, selectedAssets, setSelectedAssets, stateUninitialized])
