import { useActivityIndicator, useFetchWalletTransactionsInfinite } from '@alephium/shared-react'
...
// be deleted. By keeping an active instance of the infinite query (in this component, which stays mounted for the
// whole session), we ensure that when addresses are deleted/created the old cache will be deleted after 5 minutes but
// the latest wallet transactions will be always be persisted, leading to a better UX.
