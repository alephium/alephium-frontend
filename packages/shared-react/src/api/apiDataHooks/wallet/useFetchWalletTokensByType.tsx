...
export const UseFetchWalletTokensByTypeContextProvider = ({ children }: { children: ReactNode }) => {
...
export const useFetchWalletTokensByType = ({ includeHidden }: UseFetchWalletTokensByTypeProps) => {
  const contextData = useContext(DataContext)
  const hiddenTokenIds = useSharedSelector((s) => s.hiddenTokens.hiddenTokensIds)
