...
describe('should get the correct transaction type and origin/destinationaddresses', () => {
  ...
  it('for grouped to groupless address transfer', () => {
    ...
    const expectWalletActivityScreenWithAllAddressesAsInternal =
      makeExpectWalletActivityScreenWithAllAddressesAsInternal(fromGroupedAddress, toGrouplessAddress)
  ...
  it('for groupless internal group transfer', () => {
  ...
  it('for groupless to grouped address transfer', () => {
    ...
    const expectWalletActivityScreenWithAllAddressesAsInternal =
      makeExpectWalletActivityScreenWithAllAddressesAsInternal(fromGrouplessAddress, toGroupedAddress)
  ...
  it('for groupless to different groupless address transfer', () => {
    ...
    const expectWalletActivityScreenWithAllAddressesAsInternal =
      makeExpectWalletActivityScreenWithAllAddressesAsInternal(fromGrouplessAddress, toGrouplessAddress)
  ...
  it('for grouped to the different grouped address transfer', () => {
    ...
    const expectWalletActivityScreenWithAllAddressesAsInternal =
      makeExpectWalletActivityScreenWithAllAddressesAsInternal(fromGroupedAddress, toGroupedAddress)
  ...
  it('for groupless to the same groupless same subaddress transfer', () => {
